/** @file task_board_ibks.c
 *
 * @defgroup task_board_ibks IBKS Plus board definitions and functions
 * @{
 * @ingroup task_board
 *
 * @brief Handles LEDs, buttons, ADC sensor and watchdog for IBKS Plus 51822 board.
 */
